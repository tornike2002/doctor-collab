...
export default function AboutMeExperience() {
  ...
  const handleAddSubmit = (e) => {
    ...
    if (!newDateTo && !isPresent) validationErrors.dateTo = "End date is required or mark as Present";
  ...
  return (
    <div>
      <ExperienceList   handleDelete={handleDelete} data={data} />
      <button onClick={() => setModalToggle(true)}>Add Experience</button>
      {modalToggle && (
        <Modal>
          <ExperienceForm 
